...
st.markdown('Data gathered from [Kaggle](https://www.kaggle.com)')
...
eda_column = st.sidebar.selectbox('Columns to explroe', columns, index = None)
...
if feature:
    ...
    if df[feature].dtype == 'object':
        ...
        title = f'Mean of {feature} by {target}'
